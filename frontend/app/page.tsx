          ...
          <div className="grid md:grid-cols-5 gap-8 mb-8">
            ...
            <div className="md:col-span-1">
              ...
              <p className="text-gray-600 text-sm mb-4">
                Your AI-powered Bengali writing assistant for flawless grammar, spelling, and translation.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li><a href="#" className="hover:text-green-600 transition-colors">Grammar Checker</a></li>
                <li><a href="#" className="hover:text-green-600 transition-colors">Spelling Checker</a></li>
                <li><a href="#" className="hover:text-green-600 transition-colors">Bengali Translator</a></li>
                <li><a href="#" className="hover:text-green-600 transition-colors">AI Writing Assistant</a></li>
                <li><a href="#" className="hover:text-green-600 transition-colors">Transliteration</a></li>
                <li><a href="#" className="hover:text-green-600 transition-colors">Export Documents</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                ...
                <li><a href="#" className="hover:text-green-600 transition-colors">Free Trial</a></li>
                ...
                <li><a href="#" className="hover:text-green-600 transition-colors">Updates</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                ...
                <li><a href="#" className="hover:text-green-600 transition-colors">Getting Started</a></li>
                ...
                <li><a href="#" className="hover:text-green-600 transition-colors">Community Forum</a></li>
                <li><a href="#" className="hover:text-green-600 transition-colors">Bengali Language Guide</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                ...
                <li><a href="#" className="hover:text-green-600 transition-colors">Press Kit</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-gray-200 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <div className="text-center md:text-left">
                <p className="text-gray-600 text-sm mb-1">© 2025 GoBengali. All rights reserved.</p>
                <p className="text-gray-500 text-xs">Built with ❤️ for the Bengali community</p>
              </div>
