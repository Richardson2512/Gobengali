export const LANDING_CONTENT = {
    ...
    sections: {
        ...
        spelling: {
            title: "Fix spelling errors with context",
            description: "Avoid that \"oops\" moment after you've sent the message. GoBengali catches everything from simple typos to tricky sound-alike words."
        },
        style: {
            title: "Write in a way that truly connects",
            description: "Beyond grammar and spelling, GoBengali helps you choose the right tone and style for your audience."
        }
    }
};
